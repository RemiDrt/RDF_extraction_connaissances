...
NRI = CreerCoauteurs()
ExportTTLtoNRI("NRI_generate/CoAuteurs_XP1.nri", NRI)
NRI = CreerCitations()
ExportTTLtoNRI("NRI_generate/Citations_XP2.nri", NRI)
NRI = CreerCopublications()
ExportTTLtoNRI("NRI_generate/Copublications_XP3.nri", NRI)
NRI = CreerCitationsP()
ExportTTLtoNRI("NRI_generate/CitationsP_XP4.nri", NRI)
NRI = CreerCooccurence()
ExportTTLtoNRI("NRI_generate/Cooccurence_XP5.nri", NRI)
NRI = CreerCitationsE()
ExportTTLtoNRI("NRI_generate/CitationsE_XP6.nri", NRI)
NRI = CreerPubAut()
ExportTTLtoNRI("NRI_generate/PubAut_bi_XP7.nri", NRI)
NRI = CreerAutPubCitees()
ExportTTLtoNRI("NRI_generate/AutPubCitees_bi_XP8.nri", NRI)
NRI = CreerPubAutCites()
ExportTTLtoNRI("NRI_generate/PubAutCites_bi_XP9.nri", NRI)
